...
right_hand_center_x = 0
right_hand_center_y = 0
left_hand_center_x = 0
left_hand_center_y = 0
    ...
    for i in range(16):
        ...
        if i % 2 == 0:
            ...
            for (x, y) in zip(x_point_array, y_point_array):
                ...
                check_point_condition = (radius <= distance and distance <= radius + thickness) or check_point_condition
